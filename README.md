...
**Look / terrain pivot:** `/?demo=look` or `/?demo=terrain` (PNW hero: Seattle + Juneau–Seattle pulse). `/?demo=look&focus=seattle`. Officers: `/?demo=look&panel=officers`. Iso field: `/?demo=look&fx=battle`. M113 hulls: `/?demo=look&fx=battle&hull=1`. World atlas: `/?demo=look&view=world`. Europe: `/?demo=look&view=europe`. USSR: `/?demo=look&view=ussr`. Middle East and North Africa: `/?demo=look&view=mideast`. Sub-Saharan Africa: `/?demo=look&view=africa`.
