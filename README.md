...
**Look / terrain pivot:** `/?demo=look` or `/?demo=terrain` (topo land, pale roads, node + faction flag, 80s marks). Officers face grid: `/?demo=look&panel=officers`. Iso field: `/?demo=look&fx=battle`.
