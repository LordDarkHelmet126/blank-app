...
| `data/world/` | Atlas added one region at a time. Region 1 is the full United States (50 states + DC). Region 2 is Canada (10 provinces, Yukon, and the Northwest Territories, which still includes the eastern Arctic). Region 3 is Mexico, Central America, and the Caribbean. Region 4 is South America, including the 1985–88 Brazilian states and the British-held Falklands. Region 5 is Western Europe for 1985–89: the two Germanies, West Berlin's air corridors, the 1974 UK counties, France's 96 departments, and the Nordic and Mediterranean states. Region 6 is Eastern Europe and the fifteen union republics: Poland's 49 voivodeships, Czechoslovakia, Hungary, Romania, the 1987 Bulgarian oblasti, Yugoslavia, Albania, and the RSFSR through Kamchatka, Chukotka, Sakhalin, and the Kurils. Region 7 is the Middle East and North Africa for 1985–89: the two Yemens, a dormant Iran–Iraq front, Lebanon's security zone, Egyptian Sinai, Moroccan Western Sahara, undivided Sudan, and a Soviet-occupied Afghanistan. Region 8 is sub-Saharan Africa for 1985–89: Ethiopia still includes Eritrea, Somalia is undivided, Zaire keeps that name, Namibia is South West Africa, South Africa's homelands are zones, Angola and Mozambique mark dormant civil-war fronts, and the islands include French Réunion and Mayotte. Region 9 is Asia and Oceania for 1985–89: the end-1987 Indian map, China with Hainan as a province and Tibet as the Xizang autonomous region, British Hong Kong and Portuguese Macau, the ROC on Taiwan, the Mongolian People's Republic, North and South Korea beside the existing campaign desks, Japan's 47 prefectures, Burma under that name, the PRK in Cambodia, occupied East Timor, and the Pacific through the Trust Territory. Those cities stay occupied and off the march until a later reach. |
...
**Look / terrain pivot:** `/?demo=look` or `/?demo=terrain` (PNW hero: Seattle + Juneau–Seattle pulse). `/?demo=look&focus=seattle`. Officers: `/?demo=look&panel=officers`. Iso field: `/?demo=look&fx=battle`. M113 hulls: `/?demo=look&fx=battle&hull=1`. World atlas: `/?demo=look&view=world`. Europe: `/?demo=look&view=europe`. USSR: `/?demo=look&view=ussr`. Middle East and North Africa: `/?demo=look&view=mideast`. Sub-Saharan Africa: `/?demo=look&view=africa`. Asia and Oceania: `/?demo=look&view=asia`.
