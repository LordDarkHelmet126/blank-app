...
export const AUSTRIA_REGION = land({
  ...
  notes: "Atlas only. Nine Bundesländer. Brenner, Reschen, and Tarvisio are the Italian passes; Kufstein and Salzburg take the German autobahns. Wullowitz and Petržalka enter Czechoslovakia, Klingenbach–Sopron enters Hungary, and Loibl and Spielfeld enter Yugoslavia. Neutral, occupied on this map, and off the week-0 march.",
  defaultBiome: "alpine",
  climate: {"_default": {"sun": 2, "weather": 3}},
  biome: {},
  subs: [
...
export const ITALY_REGION = land({
  ...
  notes: "Atlas only. Twenty regions, including Sicily and Sardinia. The Strait of Messina is a ferry, not a bridge. Sardinia is reached from Civitavecchia and Genoa. Alpine tunnels are Mont Blanc, Fréjus, Great St Bernard, Simplon, and the coastal road at Ventimiglia. Fernetti–Sežana is the road into Yugoslavia; Split–Ancona and Bar–Bari are ferries. Occupied and off the week-0 march.",
