...
export const MISSION_TEMPLATES = [
  ...
  },
  {
    ...
    flavor: {
      ...
      seattle: "Wharf drums behind a clerk's wire. Quiet in, quieter out.",
      colorado_springs: "Airlift hut off the gravel strip. Take stove oil, leave the hulks.",
      boise: "Highway cache under a copper stencil. Cut the lock; leave the speech.",
    },
  ...
  },
  {
    ...
    flavor: {
      ...
      portland: "I-5 haul. Spine trucks and analog radios, no drones.",
      cheyenne: "Yard column. Brotherhood stamps; you count hulls.",
      grand_junction: "West-slope orchard road. Jeeps and a ranch scout on the same dust.",
    },
  ...
  },
  {
    ...
    flavor: {
      ...
      jackson: "Hole-town porch. Horse scout, analog set, Idle Hour minutes.",
      denver: "Campus hall on the mile. Mimeograph and a handshake, not a film unit.",
    },
